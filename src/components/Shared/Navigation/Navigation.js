...
import cartImg from "../../../images/mobile-product7.png"
                    ...
                    <div className="navbar text-black">
                            ...
                            <div className=" bg-white">
                                <form className="flex">
                                    <div className="form-control w-full max-w-xs relative">
                                        {/* serarch icon area */}
                                        <div className="absolute w-[18%] p-[15px] bg-green-600 text-white rounded-l-[9999px]">
                                            <FaSearch />
                                        </div>
                                        {/* serarch icon area */}
                                        <input
                        ...
                        <div className="navbar-end flex  items-center">
                            <NavLink
                                to="/login"
                            >
                                <button className="visible text-base font-semibold md:mr-5 border p-2 rounded-lg border-slate-300">Login</button>
                            </NavLink>
                            <NavLink
                                to="/wishlist"
